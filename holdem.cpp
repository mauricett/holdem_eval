...
int main()
{
	//int board[10]{ 0,5, 4, 1, 2, 3, 3, 3 , 0, 3 }; // = { (rank1, rank2 ...), (suit1, suit2 ...) };n
	...
	//int hands1[24] = { 6, 12, 2, 0, 3, 4, 0, 0, 0, 12, 1, 1, 6, 12, 1, 3 }; 
	//int hands1[24] = { 2, 3, 0, 1, 7, 8, 2, 3, 10, 11, 1, 1, 5, 5, 0, 1 }; 
